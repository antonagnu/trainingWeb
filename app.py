...
def overview():
    ...
    bestWeek=db_management.getBestWeek()
    usualLocation=db_management.getUsualLocation()


    return render_template("overview.html",usualLocation=usualLocation,bestMonth=bestMonth,  bestYearDistance=bestYearDistance, bestYearDate=bestYearDate,actCount=actCount ,bestWeek=bestWeek, longest=longest, totalDist=totalDist, totalElev=totalElev, maxElev=maxElev, totalHours=totalHours, avgHr=avgHr, maxHr=maxHr)       
